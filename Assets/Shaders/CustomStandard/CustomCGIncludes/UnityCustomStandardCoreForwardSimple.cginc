...
// Gone Mad Studios -- Custom Standard Core Forward Simple

#ifndef UNITY_CUSTOM_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define UNITY_CUSTOM_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
...
half4 fragForwardBaseSimpleInternal (VertexOutputBaseSimple i)
{
    ...
    c += Emission(i.tex.xy, dissolveCoord);
